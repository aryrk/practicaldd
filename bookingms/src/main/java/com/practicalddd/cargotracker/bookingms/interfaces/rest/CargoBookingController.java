...
public class CargoBookingController {
    ...
    public void bookCargo(@RequestBody final BookCargoResource bookCargoCommandResource) {
        ...
        System.out.println("BookCargoResource: " + bookCargoCommandResource);
        BookCargoCommand command = BookCargoCommandDTOAssembler.toCommandFromDTO(bookCargoCommandResource);
        System.out.println("BookCargoCommand: " + command);
